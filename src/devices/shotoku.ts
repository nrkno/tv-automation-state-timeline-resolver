...
export class ShotokuDevice extends DeviceWithState<TimelineState> implements IDevice {
	...
	handleState(newState: TimelineState, newMappings: Mappings) {
		...
		const oldAbstractState = this.convertStateToShotokuShots(oldState)
		const newAbstractState = this.convertStateToShotokuShots(newState)
